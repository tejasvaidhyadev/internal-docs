...
<CardGroup cols={2}>
  <Card title="JSON Validation" icon="check">
    Each line must be valid JSON syntax
  </Card>
  <Card title="Text Field" icon="text">
    Each object must contain a `text` field with string content
  </Card>
  <Card title="Content Types" icon="code">
    Text can contain code, natural language, or mixed content
  </Card>
  <Card title="Encoding" icon="globe">
    Supports any text encoding (UTF-8 recommended)
  </Card>
</CardGroup>
