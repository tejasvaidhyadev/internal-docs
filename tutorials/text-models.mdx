...
<CardGroup cols={2}>
  <Card 
    ...
    color="#935095"
  >
    Start with 2e-5 for fine-tuning, 3e-4 for training from scratch
  </Card>
  <Card 
    title="Batch Size" 
    icon="layers"
    color="#B47BB6"
  >
    Use largest batch size that fits in memory (16-64 typically works well)
  </Card>
  <Card 
    ...
    color="#6F3A71"
  >
    Match your data's typical length; longer sequences need more memory
  </Card>
  <Card 
    title="Validation" 
    icon="check-circle"
    color="#935095"
  >
    Always reserve 10-20% of data for validation
  </Card>
</CardGroup>
